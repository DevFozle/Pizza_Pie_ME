jQuery(function($){
	...
	window.PB_CALENDAR_DEFAULTS = {
		...
		'min_yyyymm' : null,
		'max_yyyymm' : null,
		'next_month_button' : '<i class="fa fa-chevron-down" aria-hidden="true"></i>',
		'prev_month_button' : '<i class="fa fa-chevron-up" aria-hidden="true"></i>',
	...
	var _pb_calendar = (function(target_, options_){
		...
		this._target.append('<div class="top-frame">' + 
			...
			'<span class="title">Calendar of the Month of </span>' +
			'<span class="month"></span>'+ ' - '+ 
				'<span class="year"></span>'+
				
			'</div>'+ 
			'<div class="control-frame">'+ 
				'<a href="#" class="control-btn">'+this._options['prev_month_button']+'</a>'+ 
				'<a href="#" class="control-btn">'+this._options['next_month_button']+'</a>'+ 
			'</div>'+ 
		'</div>');
		...
		this._target.append("<div class='color-map'><div class='red-map'><i class='fa fa-square' aria-hidden='true'></i>Last events</div><div class='green-map'><i class='fa fa-square' aria-hidden='true'></i>Next events</div></div>");
